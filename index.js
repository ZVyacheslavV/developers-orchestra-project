...
document.addEventListener("DOMContentLoaded",()=>{const{toggleBtn:e,mobileMenu:t,menuLinks:a}=s;function r(){t.classList.add("active"),e.classList.add("active")}function n(){t.classList.remove("active"),e.classList.remove("active")}e==null||e.addEventListener("click",()=>{t.classList.contains("active")?n():r()}),a==null||a.forEach(i=>i.addEventListener("click",n))});E.defaults.baseURL=ne;const U=async e=>{const{data:t}=await E.get(`${k.ARTISTS}?limit=${j}&page=${e}`);return t},ue=async e=>{const{data:t}=await E.get(`${k.ARTIST_BY_ID}${e}`);return t},pe=async e=>{const{data:t}=await E.get(`${k.ARTIST_BY_ID}${e}${k.ARTIST_ALBUMS_BY_ID}`);return t},me=async(e=1)=>{const{data:t}=await E.get(`${k.FEEDBACKS}?limit=${oe}&page=${e}`);return t},fe=async()=>{const{data:e}=await E.get(`${k.GENRES}`);return e},x=async({name:e,page:t=1,sorted:a="0",genre:r=""})=>{const{data:n}=await E.get(`${k.ARTISTS}?limit=${j}&page=${t}${e!=null&&e.length?`&name=${e}`:""}${a==="2"?"&sortName=desc":a==="1"?"&sortName=asc":""}${r?`&genre=${r}`:""}`);return n},he=async(e,t,a)=>{await E.post(`${k.FEEDBACKS}`,{name:e,rating:t,descr:a})},o={tlOpenSearch:window.matchMedia("(min-width: 1440px)").matches?null:A.timeline({paused:!0}).to(s.iconSearch,{rotate:180,duration:.35,ease:"power2.out"},0).fromTo(s.panelSearch,{opacity:0,y:-10,pointerEvents:"none"},{opacity:1,y:0,duration:.4,pointerEvents:"auto",ease:"power3.out"},0).from(s.panelSearch.children,{opacity:0,y:-6,stagger:.05,duration:.25,ease:"power2.out"},.1),tlCloseSearch:window.matchMedia("(min-width: 1440px)").matches?null:A.timeline({paused:!0}).to(s.iconSearch,{rotate:0,duration:.3,ease:"power2.in"},0).to(s.panelSearch,{opacity:0,y:-10,duration:.3,pointerEvents:"none",ease:"power2.in"},0),tlOpenSort:A.timeline({paused:!0}).to(s.iconSort,{rotate:180,duration:.35,ease:"power2.out"},0).fromTo(s.menuSort,{opacity:0,y:-10,pointerEvents:"none"},{opacity:1,y:0,duration:.4,pointerEvents:"auto",ease:"power3.out"},0).from(s.menuSort.children,{opacity:0,y:-6,stagger:.05,duration:.25,ease:"power2.out"},.1),tlCloseSort:A.timeline({paused:!0}).to(s.iconSort,{rotate:0,duration:.3,ease:"power2.in"},0).to(s.menuSort,{opacity:0,y:-10,duration:.3,pointerEvents:"none",ease:"power2.in"},0),tlOpenGenres:A.timeline({paused:!0}).to(s.iconGenres,{rotate:180,duration:.35,ease:"power2.out"},0).fromTo(s.menuGenres,{opacity:0,y:-10,pointerEvents:"none"},{opacity:1,y:0,duration:.4,pointerEvents:"auto",ease:"power3.out"},0).from(s.menuGenres.children,{opacity:0,y:-6,stagger:.05,duration:.25,ease:"power2.out"},.1),tlCloseGenres:A.timeline({paused:!0}).to(s.iconGenres,{rotate:0,duration:.3,ease:"power2.in"},0).to(s.menuGenres,{opacity:0,y:-10,duration:.3,pointerEvents:"none",ease:"power2.in"},0)};o.tlOpenSort.eventCallback("onStart",()=>{var e;(e=o.tlCloseSort)==null||e.pause(0).progress(0)});o.tlCloseSort.eventCallback("onStart",()=>{var e;(e=o.tlOpenSort)==null||e.pause(0).progress(0)});let c={name:"",page:1,sorted:0,genre:""};be();Se();ge();ve();ye();Le();we();ke();function ge(){s.searchInput.addEventListener("input",()=>{c.name=s.searchInput.value.trim()});const e=async()=>{var t;if(!((t=c.name)!=null&&t.length)){L("Silence from you");return}G();try{const{artists:a}=await x(c);s.artistsList.innerHTML="",w(a)}catch(a){L(`Silence due problem ${a}`)}q(),window.matchMedia("(min-width: 1440px)")||o.tlCloseSearch.play(0)};s.searchBtnRequest.addEventListener("click",e),s.searchInput.addEventListener("keydown",t=>{t.key==="Enter"&&e()})}async function be(){try{const t='<li data-value="all">All Genres</li>'+(await fe()).map(({genre:a})=>`<li data-value="${a}">${a}</li>`).join("");s.menuGenres.insertAdjacentHTML("beforeend",t)}catch(e){L(`While loading genres ${e}`)}}function ve(){const e=t=>{document.querySelector(".artists-dropdown-sort").contains(t.target)||(o.tlCloseSort.restart(),o.tlCloseGenres.restart(),s.btnSort.classList.remove("open"),s.menuSort.classList.remove("open"))};s.btnSort.addEventListener("click",t=>{t.stopPropagation(),s.menuSort.classList.contains("open")?(o.tlOpenSort.pause(0),o.tlCloseSort.restart(),s.btnSort.classList.remove("open"),s.menuSort.classList.remove("open")):(o.tlOpenGenres.pause(0),o.tlCloseGenres.restart(),s.btnGenres.classList.remove("open"),s.menuGenres.classList.remove("open"),o.tlCloseSort.pause(0),o.tlOpenSort.restart(),s.btnSort.classList.add("open"),s.menuSort.classList.add("open"),document.addEventListener("click",e,{once:!0}))}),s.menuSort.addEventListener("click",async t=>{const a=t.target.closest("li");if(a){s.btnSort.querySelector(".dropdown-label").textContent=a.textContent,s.btnSort.dataset.value=a.dataset.value,c.sorted=a.dataset.value,G();try{const{artists:r}=await x(c);s.artistsList.innerHTML="",w(r)}catch(r){L(`Silence due problem ${r}`)}q(),o.tlOpenSort.pause(0),o.tlCloseSort.restart(),s.btnSort.classList.remove("open"),s.menuSort.classList.remove("open")}})}async function ye(){const e=t=>{document.querySelector(".artists-dropdown-genres").contains(t.target)||(o.tlCloseGenres.restart(),o.tlCloseSort.restart(),s.btnGenres.classList.remove("open"),s.menuGenres.classList.remove("open"))};s.btnGenres.addEventListener("click",t=>{t.stopPropagation(),s.menuGenres.classList.contains("open")?(o.tlOpenGenres.pause(0),o.tlCloseGenres.restart(),s.btnGenres.classList.remove("open"),s.menuGenres.classList.remove("open")):(o.tlOpenSort.pause(0),o.tlCloseSort.restart(),s.btnSort.classList.remove("open"),s.menuSort.classList.remove("open"),o.tlCloseGenres.pause(0),o.tlOpenGenres.restart(),s.btnGenres.classList.add("open"),s.menuGenres.classList.add("open"),document.addEventListener("click",e,{once:!0}))}),s.menuGenres.addEventListener("click",async t=>{const a=t.target.closest("li");if(a){s.btnGenres.querySelector(".dropdown-label").textContent=a.textContent,s.btnGenres.dataset.value=a.dataset.value,c.genre=a.textContent==="All Genres"?"":a.textContent,G();try{const{artists:r}=await x(c);s.artistsList.innerHTML="",w(r)}catch(r){L(`Silence due problem ${r}`)}q(),o.tlOpenGenres.pause(0),o.tlCloseGenres.restart(),s.btnGenres.classList.remove("open"),s.menuGenres.classList.remove("open")}})}function Se(){if(window.matchMedia("(min-width: 1440px)").matches)return;const e=t=>{document.querySelector(".filters-content").contains(t.target)||(o.tlCloseSearch.play(0),document.removeEventListener("click",e))};s.btnSearch.addEventListener("click",t=>{t.stopPropagation(),A.isTweening(s.panelSearch)||s.panelSearch.style.pointerEvents==="auto"?(o.tlOpenSearch.pause(0),o.tlCloseSearch.restart(),document.removeEventListener("click",e)):(o.tlCloseSearch.pause(0),o.tlOpenSearch.restart(),document.addEventListener("click",e))})}function Le(){const e=async()=>{c={name:"",page:1,sorted:0,genre:""},s.btnGenres.querySelector(".dropdown-label").textContent="Genre",s.btnSort.querySelector(".dropdown-label").textContent="Sorting",s.searchInput.value="",G();try{s.artistsList.innerHTML="";const{artists:t}=await x(c);w(t)}catch(t){L(`Silence due problem ${t}`)}q(),o.tlCloseGenres.play(0),o.tlCloseSort.play(0)};s.resetBtn.addEventListener("click",e)}function we(){s.heroBtn.addEventListener("click",e=>{e.preventDefault(),document.querySelector("#artists").scrollIntoView({behavior:"smooth"})})}function ke(){document.querySelectorAll("button").forEach(e=>{e.addEventListener("click",()=>{e.blur()})})}const Ee=window.matchMedia("(max-width: 767.98px)").matches,$e=Ee?3:5;let f=null,N=!1,$=!1;function Ae(){return`
  ...
  `}function Ce(){let e=document.querySelector("[data-no-artists]");return e||(s.artistsList.insertAdjacentHTML("afterend",Ae()),e=document.querySelector("[data-no-artists]"),e.addEventListener("click",t=>{var a;t.target.closest(".btn-reset-filters")&&((a=document.querySelector('[data-action="filters-reset"]'))==null||a.click(),document.dispatchEvent(new CustomEvent("filters:reset")))})),e}function Me(){Ce().classList.remove("is-hidden")}function W(){var e;(e=document.querySelector("[data-no-artists]"))==null||e.classList.add("is-hidden")}function B(e,t=0){const a=document.querySelector("#tui-pagination");a&&a.classList.toggle("hidden",!e||t<=0)}function H(){return!!(c.name&&c.name.trim().length||c.genre&&c.genre!=="all"||c.sorted&&Number(c.sorted)!==0)}async function K({init:e=!1}={}){G();try{e&&(c.page=1);const a=H()?await x(c):await U(c.page),r=a.artists??[],n=Number(a.totalArtists)||0;if(n===0&&(f&&f.reset(0),B(!1,0)),s.artistsList.innerHTML="",w(r),e){f||($=!0,f=new te("#tui-pagination",{totalItems:n,itemsPerPage:j,page:c.page||1,visiblePages:$e,centerAlign:!0,usageStatistics:!1,template:{page:'<a href="#" class="tui-page-btn">{{page}}</a>',currentPage:'<strong class="tui-page-btn is-active" aria-current="page">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}}"><span class="tui-ico-{{type}}"></span></a>',disabledMoveButton:'<span class="tui-page-btn is-disabled tui-{{type}}"><span class="tui-ico-{{type}}"></span></span>',moreButton:'<span class="tui-page-btn tui-ellipsis">…</span>'}}),f.on("afterMove",async({page:d})=>{if(!N){N=!0,G();try{c.page=d,s.artistsList.innerHTML="";const h=H()?await x(c):await U(d),g=h.artists??[];w(g),B(g.length>0,Number(h==null?void 0:h.totalArtists)||0),$||requestAnimationFrame(Te)}catch{L("Failed to fetch artists"),w([]),B(!1,0)}finally{N=!1,$=!1,q()}}})),f.reset(n);const i=c.page||1;f.getCurrentPage()!==i?($=!0,f.movePageTo(i)):$=!0}else if(f){f.reset(n);const i=c.page||1;f.getCurrentPage()!==i?($=!0,f.movePageTo(i)):$=!0}B(n>0,n)}catch{H()&&L("Failed to fetch artists"),s.artistsList.innerHTML="",w([]),B(!1,0)}finally{q()}}function w(e=[]){const t=new URL("/developers-orchestra-project/assets/icons-B2bnHc1q.svg",import.meta.url).href;if(!Array.isArray(e)||e.length===0){W(),s.artistsList.innerHTML="",Me(),B(!1,0),document.dispatchEvent(new Event("artists:updated"));return}W();const a=e.map(({_id:r,strArtist:n="Unknown",strArtistThumb:i,strBiographyEN:d="",genres:b=[]})=>{const h=i||"https://placehold.co/736x414?text=No+Image",g=Array.isArray(b)&&b.length?`<ul class="artist-tags">${b.map(C=>`<li class="tag">${C}</li>`).join("")}</ul>`:'<ul class="artist-tags" aria-hidden="true"></ul>';return`
          ...
          </li>`}).join("");s.artistsList.insertAdjacentHTML("beforeend",a),document.dispatchEvent(new Event("artists:updated"))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{c.page=1,K({init:!0})}):(c.page=1,K({init:!0}));function Te(){const e=document.querySelector(".js-artists-top");if(!e)return;let t=parseFloat(getComputedStyle(e).scrollMarginTop)||0;t||(t=window.matchMedia("(min-width:1440px)").matches?112:window.matchMedia("(min-width:768px)").matches?96:120,e.style.scrollMarginTop=`${t}px`);const a=window.matchMedia("(prefers-reduced-motion: reduce)").matches;e.scrollIntoView({block:"start",inline:"nearest",behavior:a?"auto":"smooth"})}function Be(e){const t=Oe(e),a=X(e),r=`
    ...
    </div>`}function qe(e){return Be(e)}function Ge({descr:e,name:t,rating:a}){return`
    <div class="swiper-slide feedback-card">
      ${qe(a)}
      <p class="feedback-text">"${e}"</p>
      <p class="feedback-author">${t}</p>
    </div>`}function xe(e){const t=e.map(Ge).join("");s.feedbacksContainer.insertAdjacentHTML("beforeend",t)}function Ie(e){const t=Number(e);return Math.min(5,Math.max(0,Number.isNaN(t)?0:t))}function X(e){return Math.round(Ie(e)*2)/2}function Oe(e){const t=X(e),a=Math.floor(t);return`rating medium star-icon ${t%1!==0?"half":""} value-${a} label-hidden`}let P=null;async function Re(){var e;de();try{if(P)return;const t=((e=document.fonts)==null?void 0:e.ready)??Promise.resolve(),a=await me(1);await t;const r=Array.isArray(a==null?void 0:a.data)?a.data:[];r.length?xe(r):z(),P=new se(".swiper",{modules:[ae,re],slidesPerView:1,spaceBetween:30,pagination:{el:".swiper-pagination",clickable:!1,renderBullet:Pe},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},on:{slideChange:V}}),V(P),P.update();const n=document.querySelector("#reviews");n==null||n.classList.add("is-ready")}catch{le(),z()}finally{ce()}}Re();function Pe(e,t){return e<3?`<span class="${t}"></span>`:""}function V(e){De(e),Ne(e)}function De(e){const t=document.querySelector(".swiper-button-prev"),a=document.querySelector(".swiper-button-next");t.classList.toggle("swiper-button-disabled",e.activeIndex===0),a.classList.toggle("swiper-button-disabled",e.activeIndex===e.slides.length-1)}function Ne(e){const t=document.querySelectorAll(".swiper-pagination span");if(!t.length)return;if(t.forEach(n=>n.classList.remove("swiper-pagination-bullet-active")),t.length===1){t[0].classList.add("swiper-pagination-bullet-active");return}const a=e.activeIndex===0,r=e.activeIndex===e.slides.length-1;t.length>=3?(a?t[0]:r?t[2]:t[1]).classList.add("swiper-pagination-bullet-active"):(a?t[0]:t[1]).classList.add("swiper-pagination-bullet-active")}function z(){s.feedbacksContainer.insertAdjacentHTML("beforeend",`
    <div class="swiper-slide feedback-card">
      <p class="feedback-text">
        We are waiting for your feedback! Be the first to share your impressions.
      </p>
    </div>`);const e=document.querySelector(".swiper-nav");e==null||e.classList.add("hidden")}function He(){s.artistDetailsModalBackdrope.classList.add("modal--is-open"),document.body.style.overflow="hidden",window.addEventListener("keydown",Z),s.artistDetailsModalBackdrope.addEventListener("click",ee)}function Y(){s.artistDetailsModalBackdrope.classList.remove("modal--is-open"),document.body.style.overflow="",window.removeEventListener("keydown",Z),s.artistDetailsModalBackdrope.removeEventListener("click",ee)}function Z(e){e.key==="Escape"&&Y()}function ee(e){e.target===s.artistDetailsModalBackdrope&&Y()}function Fe(){var e;(e=s.loader)==null||e.classList.remove("is-hidden")}function _e(){var e;(e=s.loader)==null||e.classList.add("is-hidden")}async function je(e){try{Fe();const t=await ue(e),a=await pe(e),r=(a==null?void 0:a.albumsList)||[],{intFormedYear:n,intDiedYear:i,strArtist:d,strArtistThumb:b,strGender:h,intMembers:g,strCountry:C,strBiographyEN:M,genres:T}=t;let S;n&&i?S=`${n} - ${t.intDiedYear}`:n&&!i?S=`${n} - present`:S="information missing";const l=p=>{if(!p||isNaN(p))return"";const v=Math.floor(p/1e3),y=Math.floor(v/60),O=String(v%60).padStart(2,"0");return`${y}:${O}`},u=`
